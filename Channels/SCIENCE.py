    ...
    if views1 > 100000:
        ...
        try:
            ...
            if 10800 > yt.length > 120:
                ...
                main = Main("SCIENCE", video_id1,yt,captions_prompt, captions_sys_message, time_stamps_prompt, time_stamps_sys_message, intro_prompt, intro_sys_message, image_prompt, image_sys_message)
                main.main()
